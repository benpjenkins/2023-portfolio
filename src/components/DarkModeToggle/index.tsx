...
const DarkModeToggle = () => {
  ...
  return (
    <div className="flex justify-center">
      <div>
        <input
          // TODO: fix this classname that isn't passing tailwind linting
        ...
        <label
          className="inline-block pl-[0.15rem] font-semibold text-gray-800 hover:cursor-pointer dark:text-gray-200"
